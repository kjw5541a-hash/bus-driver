...
if [ $# -gt 0 ]; then
	...
	scenes=(test_route_data test_city test_input test_turn_radius test_brake test_nav_line test_traffic_signal test_violation test_passenger_plan test_boarding test_camera_view drive_smoke)
fi
