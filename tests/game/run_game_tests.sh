...
if [ $# -gt 0 ]; then
	...
	scenes=(test_route_data test_city test_input test_turn_radius test_brake test_nav_line test_traffic_signal test_violation test_passenger_plan test_boarding test_camera_view test_sections test_score_card test_run_clock test_car_follow drive_smoke)
fi
